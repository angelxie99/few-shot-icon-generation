...
class DreamBoothDataset(Dataset):
    ...
    def __init__(
        ...
        self.imagenet_style_templates_small = [
            "an image in the style of icon",
            "a cropped image in the style of icon",
            "the image in the style of icon",
            "a clean image in the style of icon",
            "a dirty image in the style of icon",
            "a dark image in the style of icon",
            "a cool image in the style of icon",
            "a close-up image in the style of icon",
            "a bright image in the style of icon",
            "a cropped image in the style of icon",
            "a good image in the style of icon",
            "a close-up image in the style of icon",
            "a nice image in the style of icon",
            "a small image in the style of icon",
            "a weird image in the style of icon",
            "a large image in the style of icon",
        ]
    ...
    def __getitem__(self, index):
        ...
        random_index = random.randint(0,len(self.imagenet_style_templates_small)-1)
        instance_prompt = self.imagenet_style_templates_small[random_index]
