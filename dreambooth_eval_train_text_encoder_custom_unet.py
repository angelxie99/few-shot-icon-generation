...
unet.load_state_dict(torch.load('unet-0.pt'))
...
def training_function(text_encoder, vae, unet, batch_size, with_prior, prior_weight,  train_dataloader ):
    ...
    text_optimizer = optimizer_class(
        text_encoder.parameters(),  # only optimize unet
        lr=learning_rate,
    )
    ...
    text_encoder, text_optimizer = accelerator.prepare(text_encoder, text_optimizer)
...
if __name__ == '__main__':
    ...
    output_image_dir = "./output_images/output_images_300_custom_unet0_text_encoder_style_3" # change accordingly
    ...
    instance_image_folder = "./style3" # change accordingly
    # ================================================
    batch_size = 2
